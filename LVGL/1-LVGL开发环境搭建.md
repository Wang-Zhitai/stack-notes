...
1. **下载安装 `Visual Studio Community 2026`，安装的时候要把 `使用C++的桌面开发` 勾选上，其余的看个人需求，随意，记得安装位置不要选C盘，自己换个合适的位置**

![image-20251101161959924](./assets/image-20251101161959924.png)

2. **安装完之后在开始菜单找到 `Visual Studio Installer` ，新增组件，搜索 `2019`，安装如下几个组件（因为LVGL官方的模拟器是基于VS2019开发的，需要把环境配置好才行）**
...
4. **点击模拟器文件夹内的 LVGL.sln 然后用 VS 打开这个工程**
